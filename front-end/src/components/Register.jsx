                    ...
                    <div className="login-content">
                        ...
                        <form className="login-form">
                            <div className="row-gap">
                                <div className="column-gap">
                                    <div className="column-container">
                                        <label className="column-label align-left" htmlFor="firstName">First Name</label>
                                    ...
                                    <div className="column-container">
                                        <label className="column-label align-left" htmlFor="lastName">Last Name</label>
                                        <div className="input-container">
                                            <input
                                                id="lastName"
                            ...
                            <div className="row-gap">
                                <div className="column-gap">
                                    <div className="column-container">
                                        <label className="column-label align-left" htmlFor="email">Email</label>
                                        <div className="input-container">
                                            <input
                                                id="email"
                                                placeholder="Email"
                                    ...
                                    <div className="column-container">
                                        <label className="column-label align-left" htmlFor="password">Password</label>
                                        <div className="input-container">
                                            <input
                                                id="password"
                                ...
                                <div className="column-container">
                                    ...
                                    <div className="select-container">
                                        <select
                                            ...
                                            <option value="Tertiary">Tertiary or university education</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button className='submit-button submit-label' type='button' onClick={() => signUpUser()}>
                                Create an account
                            </button>
                        </form>
                    </div>
