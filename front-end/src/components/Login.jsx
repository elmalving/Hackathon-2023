                ...
                <div className="align-center">
                    <div className="login-content">
                        ...
                        <form className="login-form">
                            ...
                            <div className="space-between">
                                <button className="social-container" type="button" id="g_id_onload" data-client_id="" data-context="signin" data-ux_mode="popup" data-callback="googleSignIn" data-auto_prompt="true">
                                    <div className="social-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 20" fill="none">
                                            <g clipPath="url(#clip0_607_6672)">
                                                <path d="M10.7041 8.18182V12.0546H16.1958C15.9546 13.3 15.231 14.3546 14.1456 15.0637L17.4573 17.5819C19.3868 15.8365 20.5 13.2728 20.5 10.2274C20.5 9.51831 20.4351 8.83642 20.3145 8.18193L10.7041 8.18182Z" fill="#4285F4"/>
                                                <path d="M4.98548 11.9034L4.23857 12.4637L1.59473 14.4819C3.27377 17.7455 6.71509 20.0001 10.7039 20.0001C13.459 20.0001 15.7688 19.1092 17.4572 17.5819L14.1455 15.0637C13.2364 15.6637 12.0768 16.0274 10.7039 16.0274C8.05089 16.0274 5.79677 14.2729 4.98965 11.9092L4.98548 11.9034Z" fill="#34A853"/>
                                                <path d="M1.59479 5.51822C0.899092 6.86363 0.500244 8.38184 0.500244 10C0.500244 11.6182 0.899092 13.1364 1.59479 14.4818C1.59479 14.4908 4.99004 11.9 4.99004 11.9C4.78596 11.3 4.66533 10.6636 4.66533 9.9999C4.66533 9.33617 4.78596 8.69984 4.99004 8.09984L1.59479 5.51822Z" fill="#FBBC05"/>
                                                <path d="M10.7042 3.98184C12.207 3.98184 13.5428 4.49092 14.6096 5.47275L17.5316 2.60914C15.7598 0.990976 13.4593 0 10.7042 0C6.7153 0 3.27377 2.24546 1.59473 5.51822L4.98988 8.10005C5.79688 5.73638 8.0511 3.98184 10.7042 3.98184Z" fill="#EA4335"/>
                                            </g>
                                        </svg>
                                    </div>
