...
const Navbar = () => {
    ...
    const isCurrent = (page) => {
        return page === currentPage && isHovered === currentPage
    }
            ...
            <div className='general'>
                ...
                <div className="list">
                    <div className={`link-container`}>
                        <Link to={'/'}>
                            <div className={`link-box${currentPage === '/' ? ' current-page' : ''}`}>
                    ...
                    <div className={`link-container`}>
                        <Link to={'/schedule'}>
                            <div className={`link-box${currentPage === '/schedule' ? ' current-page' : ''}`}>
                                <div className="link-icon">
                    ...
                    <div className={`link-container`}>
                        <Link to={'/progress'}>
                            <div className={`link-box${currentPage === '/progress' ? ' current-page' : ''}`}>
                                <div className="link-icon">
